  ...
  if (requests.length === 0) {
    return (
      <div className="leave_table_empty">
        ...
        <p>
          There are no leave requests matching your current search or filter.
        </p>
      </div>
    );
  }
        ...
        <table className="leave_request_table">
          <thead>
            <tr>
              ...
              <th>Status</th>
              <th>Applied On</th>
              <th className="leave_action_heading">Actions</th>
            </tr>
          </thead>
                ...
                <tr key={getRequestId(request)}>
                  ...
                  <td>
                    <div className="leave_period">
                      ...
                      <span className="leave_period_separator">→</span>
                  ...
                  <td>
                    <span className="leave_days">
                      {request.totalDays ?? request.requestedDays ?? 0}
                    </span>
                  </td>
